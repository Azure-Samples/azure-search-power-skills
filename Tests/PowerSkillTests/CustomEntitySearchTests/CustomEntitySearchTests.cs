...
namespace AzureCognitiveSearch.PowerSkills.Tests.CustomEntitySearchTests
{
    ...
    public class CustomEntitySearchTests
    {
        ...
        public async Task EmptyWordsEmptyEntities()
        {
            ...
            WebApiSkillResponse outputContent = await CustomEntitySearchHelpers.QueryEntitySearchFunction(TestData.EmptyWordsEmptyEntitiesInput);
            Assert.IsTrue(outputContent.Values[0].Errors[0].Message.Contains(TestData.EmptyWordsEmptyEntitiesError));
        }
