...
namespace AzureCognitiveSearch.PowerSkills.Tests.CustomEntitySearchTests
{
    ...
    ""values"": [
        ...
        public const string EmptyWordsEmptyEntitiesInput = @"{
    ""values"": [
        {
            ""recordId"": ""1"",
            ""data"":
        ...
        public static readonly string EmptyWordsEmptyEntitiesError = "Could not parse predefined words.json";
...
وقدم المصدر العزاء والمواساة لذوي الضحايا ولحكومتي وشعبي جمهورية أفغانستان الإسلامية وجمهورية نيجيريا الاتحادية",
            ...
            supportedMatchIndices.Add("Arabic", new int[] { 95 });
