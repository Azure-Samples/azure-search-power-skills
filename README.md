...
| --- | ----------- | -------| ----------- | ----------- | ----------- |
| [Azure OpenAI LLM Skills](AzureOpenAICustomLanguageModelSkill/README.md) | Demonstrates how to use one of OpenAI's language models for inference tasks in Azure AI Studio | Text | ![python](https://img.shields.io/badge/language-python-orange) | ![functions](https://img.shields.io/badge/deploy-Functions-blue) | ARM Template |
