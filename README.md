...
| --- | ----------- | -------| ----------- | ----------- | ----------- |
| [Azure AI Studio Open AI Custom Skills](AOAICustomSkills/README.md) | This demonstrates custom skills to do things in AOAI deployments like text summarization and entity recognition via an API call to an Open AI language model hosted in Azure AI Studio | Text | ![python](https://img.shields.io/badge/language-python-orange) | ![functions](https://img.shields.io/badge/deploy-Functions-blue) | ARM Template |
| [Azure AI Studio Custom Language Model Custom Skills](NonAOAICustomSkills/README.md) | provides various examples of how to use a customer's chosen language model for inference tasks  | Text | ![python](https://img.shields.io/badge/language-python-orange) | ![functions](https://img.shields.io/badge/deploy-Functions-blue) | ARM Template |
