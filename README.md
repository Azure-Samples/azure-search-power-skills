...
| [Open AI Embeddings](Vector/EmbeddingGenerator/README.md) | Generates vector embeddings via Azure Open AI service | Vector | ![python](https://img.shields.io/badge/language-python-orange) | ![functions](https://img.shields.io/badge/deploy-Functions-blue) | Manual | 
