...
| --- | ----------- | -------| ----------- | ----------- | ----------- |
| [Azure AI Studio Open AI Custom Skills](AOAICustomSkills/README.md) | Demonstrates how to use one of Open AI's language models for inference tasks in Azure AI Studio | Text | ![python](https://img.shields.io/badge/language-python-orange) | ![functions](https://img.shields.io/badge/deploy-Functions-blue) | ARM Template |
| [Azure AI Studio Custom Language Model Custom Skills](NonAOAICustomSkills/README.md) | Demonstrates how to use a customer's chosen language model for inference tasks in Azure AI Studio  | Text | ![python](https://img.shields.io/badge/language-python-orange) | ![functions](https://img.shields.io/badge/deploy-Functions-blue) | ARM Template |
