...
#
# This script tags the textsummarisation container image
...
docker tag text_summarization_extractor $TF_VAR_container_registry/text_summarization_extractor:$tag
docker push $TF_VAR_container_registry/text_summarization_extractor:$tag
