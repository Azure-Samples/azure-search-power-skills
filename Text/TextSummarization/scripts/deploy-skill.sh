...
echo "SEARCH_API_KEY=$TF_VAR_azure_search_admin_key" >> "$script_dir/../notebooks/.env"
...
echo "STORAGE_CONNECTION_STRING=$TF_VAR_storage_account_connection_string" >> "$script_dir/../notebooks/.env"
