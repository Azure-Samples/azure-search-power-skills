...
def write_on_blob_storage(data):
    ...
    if conn_str and container_name:
        ...
        x = "DefaultEndpointsProtocol=https;AccountName=cognitivefruocco;AccountKey=AA+RaE6SJs+QjruKFpSfgKahbYV0Oa1Eyi8pdjEULeENxt67/4UyMGhi77/xoEWxaHU1JrF4Hu5ECCVT+Y0A6g==;EndpointSuffix=core.windows.net".split(';')
