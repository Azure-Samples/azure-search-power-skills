# ImageStore
 ...
 This custom skill stores a [base64](https://en.wikipedia.org/wiki/Base64)-encoded image into blob storage, and returns the URL of the newly created blob. This is useful to make images extracted from a cognitive search pipeline's data source available downstream, without copying the actual image data to the index.
