...
namespace Tests
{
    ...
    ""values"": [
        ...
        public const string checkTest1 = "The request schema does not match expected schema. Could not find words array.";
        public const string checkTest2 = "The request schema does not match expected schema. Could not find text string.";
